...
MIDAS generates ITDC simulators from directly ASIC RTL. These simulators
...
Endpoints can leverage three types of FPGA resources:
...
\text{simif\_t::write} drive CPU-mastered MMIO; \texttt{simif\_t::pull} and
...
%might make some optimizations infeasible.  We also note that these sorts of
