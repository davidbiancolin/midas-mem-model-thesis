...
\section{On FPGA-based Simulation}

\input{tex/fpga-simulation}

\section{The Simulation Framework}\label{sec:framework}

\input{tex/midas}

\section{Memory Model Architecture}

\input{tex/model-architecture}

\section{On DRAM Memory Systems}

\input{tex/dram}

\section{DRAM Timing Models}\label{sec:dram-timing-model}
